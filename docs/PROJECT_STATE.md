...
- [ ] PR-3 RunStore identity migration Review Gate：PR-2 RuntimeContext v1 Contract Implementation 已完成；下一步如需进入 PR-3，必须先 review RunStore identity migration（behavior change 隔离），**当前不改 AgentRunner/RunStore**。
