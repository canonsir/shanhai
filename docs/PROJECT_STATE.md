...
- [ ] PR-3 RunStore Identity Migration Review Gate：PR-2 RuntimeContext v1 Implementation 已 Approved；已新增 `docs/design/runstore-identity-migration-review-v0.1.md`，下一步先确认 run_id 生命周期、RunStore API compatibility、trace identity 一致性与 AgentRunner 禁改边界，**当前仍不写 PR-3 实现、不改 RunStore/AgentRunner**。
